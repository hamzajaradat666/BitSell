    ...
    <div class="mybody">
        ...
        <div class="row">
            ...
            <form class="col-sm-12" action="db_connect.php" method="post">
                ...
                <label>Full Name<br><input class="" type="text" placeholder=""></label><br>
                <label>Address<br><input class="" type="text" placeholder=""></label><br>
                <label>City<br><input class="" type="text" placeholder=""></label><br>
                <label>ZIP Code<br><input class="" type="text" placeholder=""></label><br>
                <label>Country<br><select><option value="">--</option>
